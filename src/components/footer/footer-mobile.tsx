...
import { FooterMobileLink } from './footer-mobile-link';
    ...
    return (
        <PageContainer className="flex flex-col gap-6">
            ...
            <div className="text-on-surface-0-variant max-w-prose text-xs">
                All rights reserved &copy; {currentYear}. {BRAND_CONFIG.name} is a fictional brand
                created for demonstration purposes only. Any resemblance to real persons, living or
                dead, or actual businesses is purely coincidental. The games and services offered on
                this website are for entertainment purposes only and do not involve real money
                gambling or prizes. {BRAND_CONFIG.name} holds license number 123456 issued by the
                Gaming Authority of Fictionland on 14th June 1993.
            </div>
            <FooterSeparator />
